        ...
        <section className>
            ...
            <div className="row">
                ...
                <h5 className="text-uppercase fw-bold mb-4">Nuestros servicios</h5>
                    ...
                    <p><Link to='/tableros-electricos' className="text-reset">Diseño y construcción tableros eléctricos</Link></p>
                    <p><Link to='/obras-instalaciones' className="text-reset">Obras e instalaciones</Link></p>
