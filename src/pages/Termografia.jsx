            ...
            <main className='container'>
                <section>
                    ...
                    <div style={{ fontSize: '20px' }}>
                        ...
                        <p>Por otro lado, realizamos mediciones de puesta tierra y comprobaciones en disyuntores diferenciales. A traves de un telurómetro digital se realizan mediciones de la resistencia de puesta a tierra y para medir la resistividad del terreno.</p>
                        <p>Con el comprobador de diferenciales obtenemos el flujo de la corriente y el tiempo en el que se ha provocado el corte.</p>
                    </div>
                </section>
